...
suite(
	...
	async () => {
		...
		test("insertar registros en 'DISCOS_COMPACTOS'", async () => {
			...
			// 	[101, "Famous Blue Raincoat", 827],
			// 	[102, "Blue", 828],
			// 	[103, "Court and Spark", 829],
			// 	[104, "Past Light", 830],
			// 	[105, "Kojiki", 831],
			// 	[106, "That Christmas Feeling", 832],
			// 	[107, "Patsy Cline: 12 Greatest Hits", 832],
			// 	[108, "Carreras Domingo Pavarotti in Concert", 833],
			// 	[109, "After the Rain: The Soft Sounds of Erik Satie", 833],
			// 	[110, "Out of Africa", 832],
			// 	[111, "Leonard Cohen The Best Of", 834],
			// 	[112, "Fundamental", 835],
			// 	[113, "Bob Seger and the Silver Bullet Band Greatest Hits", 835],
			// 	[114, "Blues on the Bayou", 832],
			// 	[115, "Orlando", 836],
			// ];
			const discos_compactos = [
